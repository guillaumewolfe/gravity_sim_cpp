...
void PositionCreator::generate_buttons(){
   ...
   Button *AdjustPositionButton = new Button(playSoundFunc,0.075f, 0.5, ImVec2(0.04, 0.03),
                                ImVec4(0.05f, 0.05f, 0.05f, 1.0f),
                                ImVec4(0.27f, 0.27f, 0.17f, 1.0f),
                               "Adjust", 0.0,18.0f,
                               std::bind(&PositionCreator::AdjustPosition, this),3);
   Button *ZoomInButton = new Button(playSoundFunc,0.105f, 0.9, ImVec2(0.02, 0.02),
    ...
    Button *ZoomOutButton = new Button(playSoundFunc,0.045f, 0.9, ImVec2(0.02, 0.02),
                                ImVec4(0.1f, 0.1f, 0.1f, 1.0f),
                                ImVec4(0.17f, 0.17f, 0.17f, 1.0f),
                            "-", 0.0,28.0f,
                            std::bind(&PositionCreator::zoomOut, this),3,"normal",false,ImVec4(255,255,255,255),true); 
    Button *ResetPosButton = new Button(playSoundFunc,0.075f, 0.97, ImVec2(0.04, 0.03),
                                ImVec4(0.1f, 0.1f, 0.1f, 1.0f),
                                ImVec4(0.27f, 0.27f, 0.17f, 1.0f),
                        "Reset", 0.0,19.0f,
