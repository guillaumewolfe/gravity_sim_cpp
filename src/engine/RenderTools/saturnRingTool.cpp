...
void SaturnRingTool::initShaders() {
    std::string vertexCode = readShaderFile("../src/engine/RenderTools/Shaders/vertex_saturn.glsl");
    std::string fragmentCode = readShaderFile("../src/engine/RenderTools/Shaders/frag_saturn.glsl");
