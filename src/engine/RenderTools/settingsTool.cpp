...
void SettingsTool::generate_buttons(){
    ...
    else{playSoundFunc = nullptr;}
   Button *SaveButton = new Button(playSoundFunc,0.50f+diffposition_x, position_y, ImVec2(taille_x, taille_y),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Save", 0.2f,18.0f,
                            std::bind(&SettingsTool::SaveButton, this),5);       
   Button *ExitButton = new Button(playSoundFunc,0.50f-diffposition_x, position_y, ImVec2(taille_x, taille_y),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Cancel", 0.05f,18.0f,
                            std::bind(&SettingsTool::CloseButton, this),5);       

    ImageButton* closeButton = new ImageButton(playSoundFunc,0.50+size,0.23,ImVec2(0.025f,0.025f),0.6f,
    ...
    ImageButton* volumeButton = new ImageButton(playSoundFunc,0.5-diffx,position_y,ImVec2(taille_x,taille_y),0.6f,
                        buttonColor, buttonColor,
                        "../assets/button/volume.png", 0,
                            std::bind(&SettingsTool::setMode, this, 1),3,false,ImVec4(0.17f, 0.27f, 0.17f, 1.0f),false);
    ImageButton* screenButton = new ImageButton(playSoundFunc,0.5+diffx,position_y,ImVec2(taille_x,taille_y),0.6f,
                        buttonColor, buttonColor,
                        "../assets/button/screen.png", 0,
                            std::bind(&SettingsTool::setMode, this, 3),3,false,ImVec4(0.17f, 0.27f, 0.17f, 1.0f),false);
    ImageButton* controlsButton = new ImageButton(playSoundFunc,0.5,position_y,ImVec2(taille_x,taille_y),0.6f,
                        buttonColor, buttonColor,
...
void SettingsTool::generate_UImodes3(){
    ...
    ImageButton* screen1Button = new ImageButton(playSoundFunc,0.465f,0.45f,ImVec2(0.04f,0.05f),0.7f,
    ...
    ImageButton* screen2Button = new ImageButton(playSoundFunc,0.535f,0.45f,ImVec2(0.04f,0.05f),0.7f,
                        ImVec4(0.17f, 0.27f, 0.17f, 1.0f), ImVec4(0.17f, 0.27f, 0.17f, 1.0f),
