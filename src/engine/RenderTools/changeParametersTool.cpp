...
generate_colors();
mode = 0;
font = ImGui::GetIO().Fonts->AddFontFromFileTTF("../assets/fonts/RobotoB.ttf", 20);
planeteNameFont = ImGui::GetIO().Fonts->AddFontFromFileTTF("../assets/fonts/RobotoB.ttf", 12);
planateSelectedFont = ImGui::GetIO().Fonts->AddFontFromFileTTF("../assets/fonts/RobotoB.ttf", 16);
}
...
void ChangeParametersTool::initGeneralUI(){
    ...
    ImageButton *closeButton = new ImageButton(0.5+(0.35/2)*0.925, 0.5-(0.35/2)*0.9, ImVec2(taille_x*0.5, taille_y*0.5),0.60,
   ...
   Button *SaveButton = new Button(0.53, 0.5+(0.35/2)*0.85, ImVec2(taille_x*1.6, taille_y*0.65),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Save", 0.2f,20.0f,
                            std::bind(&ChangeParametersTool::Save, this),5);   
    Button *Cancel = new Button(0.47, 0.5+(0.35/2)*0.85, ImVec2(taille_x*1.6, taille_y*0.65),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                            "Cancel", 0.05f,19.0f,
...
void ChangeParametersTool::setMode(int mode, CelestialObject* object){
        ...
        m_object = object;
        changeMode();
        if(m_renderContext->showMinimap){
...
void ChangeParametersTool::initMode1(){
    ...
    ImageButton* reset = new ImageButton(0.6, 0.6, ImVec2(taille_y, taille_y),0.6f,
...
void ChangeParametersTool::initMode4(){
    ...
    float taille_x = 0.035f*0.8;
    float taille_y = 0.06f*0.8;
    ImageButton *closeButton = new ImageButton(0.5+(0.25/2)*0.915, 0.5-(0.2/2)*0.8, ImVec2(taille_x*0.5, taille_y*0.5),0.60,
                        button_color,button_color,
                        "../assets/button/close.png", 0,
                            std::bind(&ChangeParametersTool::closeButton, this),3,false,ImVec4(0.17f, 0.27f, 0.17f, 1.0f),false);
    imageButtonsMode4.push_back(closeButton);
    ImageButton* reset = new ImageButton(0.6, 0.505, ImVec2(taille_y*0.9, taille_y*0.9),0.6f,
                        ImVec4(0.17f, 0.27f, 0.17f, 1.0f),ImVec4(0.17f, 0.27f, 0.17f, 1.0f),
                        "../assets/button/reset2.png", 0,
   ...
   Button *SaveButton = new Button(0.53, 0.5+(0.2/2)*0.75, ImVec2(taille_x*1.6, taille_y*0.65),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Save", 0.2f,20.0f,
                            std::bind(&ChangeParametersTool::Save, this),5);   
    Button *Cancel = new Button(0.47, 0.5+(0.2/2)*0.75, ImVec2(taille_x*1.6, taille_y*0.65),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                            "Cancel", 0.05f,19.0f,
                        std::bind(&ChangeParametersTool::closeButton, this),5); 
