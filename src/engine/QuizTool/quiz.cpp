...
void Quiz::generateEasyQuiz() {
    ...
    addQuestion(Question("What is the term for the brightness of a star as seen from Earth?", {"Apparent magnitude", "Absolute magnitude", "Luminosity", "Radiance"}, 0, "Apparent magnitude is a measure of the brightness of a star as seen from Earth, and it is affected by distance."));
    ...
    addQuestion(Question("What is an astronomical unit (AU)?", {"The distance from the Earth to the Moon", "The distance from the Earth to the Sun", "The average radius of the Earth", "The distance across the Milky Way"}, 1, "An astronomical unit (AU) is the average distance from the Earth to the Sun, and it is used to measure distances within our solar system."));
...
void Quiz::generateMediumQuiz() {
    ...
    addQuestion(Question("What is a neutron star?", {"A collapsing black hole", "A very young star", "A very old star", "The remnant of a supernova"}, 3, "A neutron star is the remnant of a supernova explosion, and it is incredibly dense, with the mass of the Sun packed into a sphere only a few kilometers across."));
    ...
    addQuestion(Question("Which of these is a measure of a star's intrinsic brightness?", {"Apparent magnitude", "Absolute magnitude", "Luminosity", "Both Absolute magnitude and Luminosity"}, 3, "Absolute magnitude and luminosity are both measures of a star's intrinsic brightness, unaffected by distance."));
    ...
    addQuestion(Question("What is the habitable zone around a star?", {"Where water can exist as a solid", "Where conditions are suitable for life as we know it", "The area most illuminated by the star", "The region with the most asteroids"}, 1, "The habitable zone is the region around a star where conditions are suitable for life as we know it, including the presence of liquid water."));
    ...
    addQuestion(Question("What element is the endpoint of fusion in the core of a massive star?", {"Iron", "Hydrogen", "Carbon", "Helium"}, 0, "Iron is the endpoint of fusion in the core of a star. It cannot be fused into heavier elements without requiring more energy than it releases."));
