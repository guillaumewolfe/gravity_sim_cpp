...
void Quiz::generateMediumQuiz() {
    ...
    addQuestion(Question("Which planet has the most extreme temperature fluctuations?", {"Mercury", "Venus", "Earth", "Mars"}, 0, "Mercury has the most extreme temperature fluctuations in the solar system, with no atmosphere to retain heat, temperatures can swing over 600 degrees Celsius."));
