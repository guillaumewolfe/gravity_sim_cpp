...
void MessageTool::generate_buttons(){
    float hauteur = 0.54f;
   Button *OKButton = new Button(0.465f, hauteur, ImVec2(0.05, 0.04),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Yes", 0.2f,0,
                               std::bind(&MessageTool::OkButtonPressed, this));  
   Button *CancelButton = new Button(0.535f, hauteur, ImVec2(0.05, 0.04),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               ImVec4(150.0/255.0, 250.0/255.0, 150.0/255.0, 1.0f),
                               "Cancel", 0.05,0,
    ...
    imageButton = new ImageButton(0.50+size,0.4375,ImVec2(0.025f,0.025f),0.6f,
